...
- **company_profiles.jsonl** — Company Profiles (MOPS t05st03)
  ...
  - See **[EXAMPLES.md](EXAMPLES.md)** for ready-made query recipes
    (find a chairman across all companies, interlocking directorates, top
    companies by capital, auditor share, AI-keyword search, jq one-liners, …).
